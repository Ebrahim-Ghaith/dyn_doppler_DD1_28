...
params.num_ant_BS = [8, 1];      % Number of antenna elements for the BS arrays in the x,y,z-axes
...
params.num_ant_UE = [4, 1];      % Number of antenna elements for the user arrays in the x,y,z-axes
